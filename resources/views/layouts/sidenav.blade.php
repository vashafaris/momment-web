...
<nav style="background-color:white">
  ...
  <ul id="slide-out" class="sidenav sidenav-fixed" style="background-color: #3a3f51">
    ...
    <li><a href="{{ route('competitor') }}" style="display:{{$display}};color:#b4b6bd" ><i class="fas fa-balance-scale" style="color:white"></i>Kompetitor</a></li>
    <li><a href="{{ route('trend') }}" style="display:{{$display}};color:#b4b6bd" ><i class="fas fa-chart-line" style="color:white"></i>Tren Topik Twitter</a></li>
    <li><div class="divider"></div></li>
